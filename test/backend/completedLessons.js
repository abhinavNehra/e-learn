...
describe("Lesson APIs get: "+url+"/completedLessons",function(){
	it("should return an object",function(done){

		request
		.get(url+'/completedLessons')
...
describe("Lesson APIs get: "+url+"/completedLessons/:id",function(done){
	var completedLessonsId = testData.lesson._id;
	it("should return an object",function(done){
		request
		.get(url+'/completedLessons/'+completedLessonsId)
		.end(function(err, res){
			assert.isObject(res.body);
			done();
		})
...
describe("Lesson APIs get: "+url+"/completedLesson/anything",function(){
	it("should return an object",function(done){
		request
		.get(url+'/completedLessons/anything')
		.end(function(err, res){
			assert.isObject(res.body);
			done();
		})
